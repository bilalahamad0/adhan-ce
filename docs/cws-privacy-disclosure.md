...
| `offscreen` | Plays the subtle Adhan chime audio notification from the background service worker using the Chrome MV3 Offscreen API. No DOM or external content is loaded. |
