...
const DEFAULTS = {
  ...
  autoResumeMinutes: 5, leadSeconds: 30, focusMode: true, strictFocus: false, adhanChime: true, badgeCountdown: true, badgeMode: 'auto', badgeManualHours: 2, method: 2, school: 0,
